    ...
    IF(chunks(chunk)%chunk_neighbours(chunk_left).NE.external_face) THEN
      ...
      IF(use_ext_kernels) THEN
         CALL ext_pack_message( &
            ...
            CHUNK_LEFT,         &
            CELL_DATA,          &
            chunks(chunk)%left_snd_buffer, 1)
      ELSE
    ...
    IF(chunks(chunk)%chunk_neighbours(chunk_right).NE.external_face) THEN
      ...
      IF(use_ext_kernels) THEN
         CALL ext_pack_message( &
            ...
            CHUNK_RIGHT,        &
            CELL_DATA,          &
            chunks(chunk)%right_snd_buffer, 1)
      ELSE
    ...
    IF(chunks(chunk)%chunk_neighbours(chunk_bottom).NE.external_face) THEN
      ...
      IF(use_ext_kernels) THEN
         CALL ext_pack_message( &
            ...
            CHUNK_BOTTOM,       &
            CELL_DATA,          &
            chunks(chunk)%bottom_snd_buffer, 1)
      ELSE
    ...
    IF(chunks(chunk)%chunk_neighbours(chunk_back).NE.external_face) THEN
      ...
      IF(use_ext_kernels) THEN
         CALL ext_pack_message( &
            ...
            CHUNK_BACK,         &
            CELL_DATA,          &
            chunks(chunk)%back_snd_buffer,1)
      ELSE
    ...
    IF(chunks(chunk)%chunk_neighbours(chunk_front).NE.external_face) THEN
      ...
      IF(use_ext_kernels) THEN
         CALL ext_pack_message( &
            ...
            CHUNK_FRONT,        &
            CELL_DATA,          &
            chunks(chunk)%front_snd_buffer,1)
      ELSE
